    ...
    return (
        <div className='container'>
            ...
            <div className='button-container'>
                {status ? (isWinner ? (<button className="enter-button" onClick={claimPrize}>Claim prize </button>) : (<p>You are not the winner</p>) ) : (<button className="enter-button" onClick={enterLottery}>Enter Lottery </button>)
